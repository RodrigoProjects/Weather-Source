  ...
  <div class="flex items-center justify-center p-6 border-b  w-3/4">
    <div class="flex items-center justify-between w-48">
      <div class="flex flex-col items-center">
        ...
        <div class="header-title font-bold text-2xl opacity-70">Source</div>
      </div>
      <div>
          <i class="fas fa-cloud-sun fa-3x opacity-90 bg-gradient-to-br from-yellow-400 text-transparent bg-clip-text"></i>
      </div>
